...
@borg.on(admin_cmd(pattern="getpacks ?(.*)", allow_sudo=True))  # pylint:disable=E0602
async def _(event):
    if event.fwd_from:
        return
    ...
    if splugin_name in borg._plugins:
        ...
        s_help_string = ""
    help_string = """Your 1st sticker pack can be found [here](https://t.me/addstickers/Uniborg_Pack_843901469)
